...
\baituluan{bai:1}
{2.00} % Nếu câu không có thang điểm, xóa số trong ngoặc
{} % Nguồn
{
...
\begin{enumerate}
    % \begin{multicols}{2} % Nếu muốn các chỉ mục không chia cột thì tắt dòng này đi
        \item[\textcolor{UMTBlue}{\textbf{a.}}] {
            \textcolor{UMTRed}{\textbf{(1.00 điểm)}} % Nội dung ý con bắt đầu ở dòng kế tiếp; nếu ý con không có thang điểm, comment dòng này lại
...
\end{enumerate}
} {% Bắt đầu đáp án từ dòng kế tiếp
    Đáp án sẽ bắt đầu từ đây. \textcolor{red}{abc}.
}
...
%%%%%%%%%%%%%%%%%%%% Câu 3
\baituluan{bai:3}
{1.50} % Nếu câu không có thang điểm, xóa số trong ngoặc
{} % Nguồn
{
%%%%% Nội dung đề bắt đầu ở dòng kế tiếp %%%%%
...
\begin{enumerate}
    % \begin{multicols}{2} % Nếu muốn các chỉ mục không chia cột thì tắt dòng này đi
        \item[\textcolor{UMTBlue}{\textbf{a.}}] {
            \textcolor{UMTRed}{\textbf{(0.75 điểm)}} % Nội dung ý con bắt đầu ở dòng kế tiếp; nếu ý con không có thang điểm, comment dòng này lại
...
\baituluan{bai:6}
{0.50} % Nếu câu không có thang điểm, xóa số trong ngoặc
{} % Nguồn
{
%%%%% Nội dung đề bắt đầu ở dòng kế tiếp %%%%%
